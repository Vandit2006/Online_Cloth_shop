...
function Login() {
    ...
    useEffect(() => {
        ...
        // GSAP animation for the login container entrance
        ...
        // GSAP animation for the signup link
        gsap.fromTo('.signup-link',
            { opacity: 0 },
    ...
    return (
        <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 to-black bg-gradient-animation bg-[200%_100%]">
            ...
            <div className="login-container w-full max-w-md bg-white bg-opacity-90 backdrop-blur-md rounded-xl shadow-2xl p-10 border border-gray-200">
                <h1 className="text-3xl font-extrabold text-gray-800 text-center mb-8 tracking-tight">
                    <span className="text-indigo-600">Luxsriyas</span> Login
                </h1>
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="login-button w-full bg-indigo-600 text-white py-3 px-6 rounded-md shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 font-semibold transition-colors duration-300"
                    >
                        Sign In
                    </button>
                </form>
                <p className="mt-6 text-center text-gray-600 text-sm signup-link">
